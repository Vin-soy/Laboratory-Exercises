...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item">
      <a class="nav-link submit" data-widget="logout" href="logout.php" role="button">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="./pages/examples/<?php echo $user_image?>" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
          <a href="../../Final-C/AdminLTE-3.2.0/pages/examples/profile.php" class="d-block"><?php echo $firstname . " " . $middilename . " " . $lastname; ?></a>
        </div>
      </div>
